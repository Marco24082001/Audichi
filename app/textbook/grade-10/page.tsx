...
export default function Grade10TextbookPage() {
  return (
      ...
      <main className="mx-auto w-full max-w-[1100px] flex-1 px-4 py-12 sm:px-6">
        <section>
          ...
          <p className="mt-3 text-slate-600">
            Choose a unit to practice listening.
          </p>
        </section>
            ...
            {grade10LessonFlow.map((item) =>
              item.kind === "unit" ? (
                <UnitCard
                  ...
                  href={`/lessons?source=textbook&grade=10&unit=${item.unit}`}
                />
              ) : (
                <Link
                  key={`review-${item.review}`}
                  href={`/lessons?source=textbook&grade=10&review=${item.review}`}
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Consolidation exercises for previous units.
                  </p>
